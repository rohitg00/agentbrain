...
- [`artifact-contract`](artifact-contract/SKILL.md) — Use when an output artifact, template, schema, example, or handoff field must stay aligned across commands, skills, docs, and validators.
