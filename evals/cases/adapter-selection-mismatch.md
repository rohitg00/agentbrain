...
## Harness route
Run `/brain-verify` with `adapter-capability-probe`, `runtime-smoke`, and `agent-output-verifier` to check adapter selection evidence before executing the workflow. Route files: `commands/brain-verify.md`, `skills/adapter-capability-probe/SKILL.md`, `skills/agent-output-verifier/SKILL.md`, `skills/runtime-smoke/SKILL.md`.
