...
List the primary artifacts, templates, schemas, logs, reports, or changed files a resuming agent must inspect before continuing. Include at least one path even when blocked so the next runtime knows where the evidence or blocker lives.
